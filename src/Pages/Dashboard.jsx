                    ...
                    <div className="w-full navbar bg-base-300">
                        ...
                        <div className="flex-1 px-2 mx-2 gap-3">
                            <Link className="flex items-center px-2 mx-2 gap-3" to="/">
                                ...
                                ? 
                                <><h1 className="font-semibold text-xl uppercase">Admin Dashboard</h1></> 
                                : 
                                instructor 
                                ? 
                                <><h1 className="font-semibold text-xl uppercase">Instructor Dashboard</h1></> : 
                                <><h1 className="font-semibold text-xl uppercase">General Dashboard</h1></>}</h1>
                            </Link>
                        </div>
                            ...
                            <ul className="menu menu-horizontal">
                                ...
                                {admin ? (
                                    <ul className="flex items-center">
                                        <li><NavLink className="text-blue-600 font-semibold tracking-wide transition-colors duration-200 uppercase" to="/dashboard/manageUsers"><FaUsersCog size={20} /> MANAGE USERS</NavLink ></li>
                                    </ul>
                                ) : instructor ? (
                                    <ul className="flex items-center">
